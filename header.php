...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span style="text-decoration:none;" class="logo-lg"><b>Ags</b> Jewellers</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="add-emp.php"><i class="fa fa-user-plus"></i>Add Employee</a></li>
            <li><a href="manage-emp.php"><i class="fa fa-cog"></i>Manage Employee</a></li>
          </ul>
        </li>
