...
<body>
	<div class="container">
		...
		<div class="top-buttons btn-group">
			<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Employee <span class="caret"></span></button>
		  	<ul class="dropdown-menu" role="menu">	
		  		<li><a href="add-emp.php">Add Employee</a></li>	    
				<li><a href="manage-emp.php">Manage Employee</a></li>
		  	</ul>
		</div>
